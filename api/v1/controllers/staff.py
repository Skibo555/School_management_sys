...
from ..schemas.requests import StudentIn
...
class StudentManager:
    @staticmethod
    async def add_students(student_data: StudentIn, db: Session = Depends(get_db)):
    ...
    @staticmethod
    async def get_student_with_id(student_id, db: Session = Depends(get_db)):
    ...
    @staticmethod
    async def get_student_with_email(student_email, db: Session = Depends(get_db)):
